...
|client.datafileURLTemplate|OPTIMIZELY_CLIENT_DATAFILEURLTEMPLATE|The endpoint for retrieving the datafile. Default: https://cdn.optimizely.com/datafiles/%s.json|
