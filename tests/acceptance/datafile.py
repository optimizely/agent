datafile = {'accountId': '10845721364',
 'anonymizeIP': True,
 'attributes': [{'id': '16921322086', 'key': 'attr_1'}],
 'audiences': [{'conditions': '["and", ["or", ["or", {"match": "exact", "name": "attr_1", "type": "custom_attribute", '
                              '"value": "hola"}]]]',
                'id': '16902921321',
                'name': 'Audience1'},
               {'conditions': '["or", {"match": "exact", "name": "$opt_dummy_attribute", "type": "custom_attribute", '
                              '"value": "$opt_dummy_value"}]',
                'id': '$opt_dummy_audience',
                'name': 'Optimizely-Generated Audience for Backwards Compatibility'}],
 'botFiltering': False,
 'environmentKey': 'production',
 'events': [{'experimentIds': ['16911963060', '9300002877087', '16910084756'], 'id': '16911532385', 'key': 'myevent'}],
 'experiments': [{'audienceConditions': ['or', '16902921321'],
                  'audienceIds': ['16902921321'],
                  'forcedVariations': {},
                  'id': '16910084756',
                  'key': 'feature_2_test',
                  'layerId': '16933431472',
                 ...
                 {'audienceConditions': ['or', '16902921321'],
                  'audienceIds': ['16902921321'],
                  'forcedVariations': {},
                  'id': '16911963060',
                  'key': 'ab_test1',
                 ...
                 {'audienceConditions': ['or', '16902921321'],
                  'audienceIds': ['16902921321'],
                  'cmab': {'attributeIds': ['16921322086'], 'trafficAllocation': 10000},
                  'forcedVariations': {},
                  'id': '9300002877087',
                  'key': 'cmab-rule_1',
 ...
 'featureFlags': [{'experimentIds': [],
                  ...
                  {'experimentIds': [],
                   ...
                   'variables': [{'defaultValue': 'hello', 'id': '16916052157', 'key': 'str_var', 'type': 'string'},
 ...
 'region': 'US',
 'revision': '139',
 'rollouts': [{'experiments': [{'audienceConditions': [],
                                'audienceIds': [],
                                'forcedVariations': {},
                                ...
                                'layerId': '16909553406',
                                'status': 'Running',
                                'trafficAllocation': [{'endOfRange': 10000, 'entityId': '471185'}],
                                'variations': [{'featureEnabled': False,
                                                'id': '471185',
                                                'key': 'off',
                                                'variables': []}]}],
               'id': '16909553406'},
              {'experiments': [{'audienceConditions': [],
                                'audienceIds': [],
                                'forcedVariations': {},
                                ...
                                'layerId': '16943340293',
                                'status': 'Running',
                                'trafficAllocation': [{'endOfRange': 10000, 'entityId': '16925940659'}],
                                'variations': [{'featureEnabled': True,
                                                'id': '16925940659',
                                                'key': '16925940659',
                                                'variables': []}]}],
               'id': '16943340293'},
              ...
              {'experiments': [{'audienceConditions': ['or', '16902921321'],
                                ...
                                'layerId': '16928980969',
                                'status': 'Running',
                                'trafficAllocation': [{'endOfRange': 10000, 'entityId': '16906801184'}],
                                'variations': [{'featureEnabled': True,
                                                'id': '16906801184',
                                                'key': '16906801184',
                                                'variables': [{'id': '16916052157', 'value': 'hello'},
                                                              {'id': '16923002469', 'value': '5.6'},
                                                              {'id': '16932993089', 'value': 'true'},
                               ...
                               {'audienceConditions': [],
                                ...
                                'layerId': '16928980969',
                                'status': 'Running',
                                'trafficAllocation': [{'endOfRange': 10000, 'entityId': '471188'}],
                                'variations': [{'featureEnabled': False,
                                                'id': '471188',
                                                'key': 'off',
                                                'variables': [{'id': '16916052157', 'value': 'hello'},
              ...
              {'experiments': [{'audienceConditions': ['or', '16902921321'],
                               ...
                               {'audienceConditions': [],
                                ...
                                'layerId': '16917900798',
                                'status': 'Running',
                                'trafficAllocation': [{'endOfRange': 10000, 'entityId': '471189'}],
                                'variations': [{'featureEnabled': False,
                                                'id': '471189',
                                                'key': 'off',
                                                'variables': []}]}],
              ...
              {'experiments': [{'audienceConditions': [],
                                ...
                                'status': 'Running',
                                'trafficAllocation': [{'endOfRange': 10000, 'entityId': '471190'}],
                                'variations': [{'featureEnabled': False,
                                                'id': '471190',
                                                'key': 'off',
                                                'variables': []}]}],
              ...
              {'experiments': [{'audienceConditions': [],
                                ...
                                'status': 'Running',
                                'trafficAllocation': [{'endOfRange': 10000, 'entityId': '1579277'}],
                                'variations': [{'featureEnabled': False,
                                                'id': '1579277',
                                                'key': 'off',
                                                'variables': []}]}],
