...
test-acceptance:
	...
	pytest -vv tests/acceptance/test_acceptance/test_datafile.py
	pytest -vv -rA --diff-symbols --ignore=tests/acceptance/test_acceptance/test_datafile.py tests/acceptance/test_acceptance/ \
