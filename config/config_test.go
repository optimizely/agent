...
func TestDefaultConfig(t *testing.T) {
	...
	assert.Equal(t, false, conf.Client.DisableOdp)
	assert.Equal(t, 10000, conf.Client.SegmentsCacheSize)
	assert.Equal(t, 600*time.Second, conf.Client.SegmentsCacheTimeout)
