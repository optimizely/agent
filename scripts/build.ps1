...
function main($mode) {
    ...
    checkPrereq 'Go Programming Language amd64 go1.13.5' https://dl.google.com/go/go1.20.1.windows-amd64.msi f06fdfa56f3aba62cbf80dacddbcc1150f4990cc117a9477047d3a3529ee3e80 $mode
    # same but with git
